...
This is a simple script to download all [RS](http://www.regionalbus.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"1700599","Bad Liebenstein Gymnasium",10.649169,51.10114,""
```
